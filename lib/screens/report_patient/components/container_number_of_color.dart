...
class ContainerNumberOfColor extends StatelessWidget {
  final _listData = [
    NumberOfColor(
      color: Colors.green.shade400.withOpacity(.75),
      title: "ผู้ป่วยเสี่ยง",
      value: 0,
    ),
    SizedBox(
    ...
    NumberOfColor(
      color: Colors.yellow.shade400.withOpacity(.75),
    ...
    NumberOfColor(
      color: Colors.red.shade400.withOpacity(.75),
    ...
    NumberOfColor(
      color: Colors.red.shade800.withOpacity(.75),
    ...
    NumberOfColor(
      color: Colors.pink.shade300.withOpacity(.75),
